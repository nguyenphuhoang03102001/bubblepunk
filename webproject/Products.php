                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                      <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active">
                        <img class="d-block w-100 h-50" src="http://drive.google.com/uc?export=view&id=1yZ8PmdmSf9aeGsr5El_0gSaierLRoIoy" alt="First slide">
                      </li>
                      <li data-target="#carouselExampleIndicators" data-slide-to="1">
                        <img class="d-block w-100 h-50" src="http://drive.google.com/uc?export=view&id=1P7D1ELoNutEDGQRMKJ0d6rOUsKSyfiv0" alt="Second slide">
                      </li>
                      <li data-target="#carouselExampleIndicators" data-slide-to="2">
                        <img class="d-block w-100 h-50" src="http://drive.google.com/uc?export=view&id=1NXfVvwOxJVnUJl5zdUgc0V5ruOEcbvK1" alt="Third slide">
                      </li>
                    </ol>
