  ...
  <div class="body">
    <div class="container-lg">
      ...
      <div class="ads d-none d-lg-block">
        <div class="card-deck">
          <div class="card">
            <img src="http://drive.google.com/uc?export=view&id=1mMSeSgW-6GTbCxCXa2PZw1V1cHZVU88U" alt="">
          </div>
          <div class="card">
            <img src="http://drive.google.com/uc?export=view&id=1FEdTFVDz_DHPgO_wr0tS8biMXvhFu2dZ" alt="">
          </div>
          <div class="card">
            <img src="http://drive.google.com/uc?export=view&id=1DVDygZLNT0tgDAJcmge0Yk58lnYwRduV" alt="">
          </div>
        </div>
      ...
      <div class="products">
        ...
        <div class="game">
          ...
          <div class="row">
            <?php
            $result = runQueryReturn($link, "Select * from tb_product where PlatformID=1");
            while ($rows = mysqli_fetch_assoc($result)) {
              echo "<div class='col-lg-3 col-4'>";
              echo "<a href='http://localhost:3000/Products.php?pid=".$rows['ProductID']."'>";
              echo "<div class='card'>";
        ...
        <div class="game">
          ...
          <div class="row">
            <?php
            $result = runQueryReturn($link, "Select * from tb_product where PlatformID=2");
            while ($rows = mysqli_fetch_assoc($result)) {
              echo "<div class='col-lg-3 col-4'>";
              echo "<a href='http://localhost:3000/Products.php?pid=".$rows['ProductID']."'>";
              echo "<div class='card'>";
        ...
        <div class="game">
          ...
          <div class="row">
            <?php
            $result = runQueryReturn($link, "Select * from tb_product where PlatformID=4 or PlatformID=6");
            while ($rows = mysqli_fetch_assoc($result)) {
              echo "<div class='col-lg-3 col-4'>";
              echo "<a href='http://localhost:3000/Products.php?pid=".$rows['ProductID']."'>";
              echo "<div class='card'>";
