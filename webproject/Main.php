    ...
    <div class="container-lg">
      ...
      <div class="products">
        <div class="acc">
          ...
          <div class="row">
            <?php
            $result = runQueryReturn($link, "Select * from tb_product order by RAND() limit 4");
            while ($rows = mysqli_fetch_assoc($result)) {
              echo "<div class='col-lg-3 col-4'>";
              echo "<a href='http://localhost:3000/Products.php?pid=".$rows['ProductID']."'>";
              echo "<div class='card h-70'>";
              echo "<img class='card-img-top' src=" . $rows['ProductImg'] . " alt='Card image cap'>";
              echo "<div class='card-body'>";
              echo "<h4 class='text-truncate' style='color:black;width: 10rem;'class='card-title'>" . $rows['ProductName'] . "</h4>";
